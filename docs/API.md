...
Делает несколько попытко прочесть RFID-метку. Останавливается, когда находит метку, или когда заканчивается установленный лимит попыток. Была ли метка прочитана или нет, возвращается в scanResult.
