...
| --- | -------- | ----- | --------------- | ----------------------------------------- |
| 1 | Наличие формальных артефактов | 0..5 | 4 балла - наличие репозитория команды с кодом;<br> 1 балл - наличие отчёта команды в репозитории (в свободной форме написать о впечатлениях о соревнованиях (пожелания, замечания, предложения по улучшению, как технических, так и организационных моментов); описания используемых в решении алгоритмов, трудностей, возникших в процессе решения задания, как они были преодолены (или не были) и т.д.). | |
